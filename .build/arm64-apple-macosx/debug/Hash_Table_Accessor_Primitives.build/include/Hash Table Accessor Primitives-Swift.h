...
#ifndef HASH_TABLE_ACCESSOR_PRIMITIVES_SWIFT_H
#define HASH_TABLE_ACCESSOR_PRIMITIVES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Hash_Table_Accessor_Primitives",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
