...
#ifndef SWIFT_EXECUTOR_PRIMITIVESPACKAGETESTS_SWIFT_H
#define SWIFT_EXECUTOR_PRIMITIVESPACKAGETESTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="swift_executor_primitivesPackageTests",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
